...
const KNOWN_CITIES = [
  ...
  'AURORA', 'BRANTFORD', 'COLLINGWOOD', 'GRIMSBY', 'HAMILTON', 'LONDON', 'NIAGARA FALLS',
];
    ...
    <SiteNavbar />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-12 font-mono text-xs">
          ...
          >
            {['ALL', 'TORONTO', 'MISSISSAUGA', 'OAKVILLE', 'BRAMPTON', 'WHITBY', 'BARRIE', 'VAUGHAN', 'BURLINGTON', 'OSHAWA', 'PICKERING', 'RICHMOND HILL', 'MARKHAM', 'CALEDON', 'NEWMARKET', 'GUELPH', 'MILTON', 'CAMBRIDGE', 'KITCHENER', 'ADJALA-TOSORONTIO', 'STOUFFVILLE', 'BOWMANVILLE', 'WOODSTOCK', 'ORANGEVILLE', 'ALLISTON', 'WELLAND', 'AURORA', 'BRANTFORD', 'COLLINGWOOD', 'GRIMSBY', 'HAMILTON', 'LONDON', 'NIAGARA FALLS', 'BRESLAU'].map((city) => (
