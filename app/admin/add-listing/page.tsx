...
const ONTARIO_CITIES = ['TORONTO', 'MISSISSAUGA', 'OAKVILLE', 'BRAMPTON', 'WHITBY','BARRIE','VAUGHAN','BURLINGTON','OSHAWA','PICKERING','RICHMOND HILL','MARKHAM', 'CALEDON', 'NEWMARKET', 'GUELPH', 'MILTON', 'CAMBRIDGE', 'KITCHENER', 'ADJALA-TOSORONTIO', 'ALLISTON', 'STOUFFVILLE', 'BOWMANVILLE', 'WOODSTOCK', 'ORANGEVILLE','WELLAND', 'AURORA', 'BRANTFORD', 'COLLINGWOOD', 'GRIMSBY', 'HAMILTON', 'LONDON', 'NIAGARA FALLS', 'BRESLAU'];
