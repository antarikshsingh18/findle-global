...
export const metadata: Metadata = {
  title: 'Losani Homes | New & Pre-Construction Communities in Ontario | Findle',
  description: 'Explore Losani Homes communities, townhomes, detached homes, and condos across Hamilton, Stoney Creek, Grimsby, and Southern Ontario on Findle.',
};

export default async function LosaniHomesPage() {
  ...
  // 2. Filter properties specifically for Losani Homes using clean normalization
          ...
          <div className="grid items-center gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              <div className="mb-3 text-[9px] uppercase tracking-[0.22em] text-indigo-400">
                Verified Developer Profile // Founded 1976 // Nearly 5 Decades Experience
              </div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-300 font-sans">
                Losani Homes is one of Ontario’s longest-established homebuilders, with a history dating back to 1976. Based in Hamilton, Ontario, the company has spent nearly five decades developing residential communities across Hamilton, Niagara Region, Brantford, and surrounding growth markets.
              </p>
            </div>
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-xl border border-slate-700 bg-slate-950 flex items-center justify-center p-6">
                ...
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRSzrS2ULrPnH7Zy27h1eXadEIvUefDpwo-HYoZ-AtZw&s=10"
                  alt="Losani Homes logo"
        ...
        <section className="mb-16 grid grid-cols-1 md:grid-cols-2 gap-8 border border-slate-800 bg-slate-900/20 p-6 sm:p-8 rounded-2xl">
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-300 font-sans">
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Developer:</strong> Losani Homes</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Founded:</strong> 1976</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Headquarters:</strong> Hamilton, Ontario</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Primary Markets:</strong> Hamilton, Niagara Region, Brantford, Waterloo Region</li>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-slate-300 font-sans">
              <div>
                <strong className="text-white font-mono text-xs uppercase block text-indigo-400">Hamilton & Stoney Creek Base</strong>
                <p className="text-xs mt-1">Headquartered in Hamilton with prominent master-planned communities spanning Stoney Creek, Ancaster, and Binbrook.</p>
              </div>
              <div>
                <strong className="text-white font-mono text-xs uppercase block text-indigo-400">Niagara & Southwestern Expansion</strong>
                <p className="text-xs mt-1">Active developments expanding across Grimsby, Niagara Falls, Brantford, Kitchener, and Waterloo.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          {developerProperties.length > 0 ? (
            ...
            <div className="grid grid-cols-1 gap-y-12 gap-x-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-white mt-2">Foothills of Winona</h3>
                <p className="text-xs text-slate-400 mt-1">Stoney Creek, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes & Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Central Park</h3>
                <p className="text-xs text-slate-400 mt-1">Hamilton, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Townhomes & Urban Homes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Fifty</h3>
                <p className="text-xs text-slate-400 mt-1">Stoney Creek, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes & Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Heritage Green</h3>
                <p className="text-xs text-slate-400 mt-1">Hamilton, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes & Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">AquaZul</h3>
                <p className="text-xs text-slate-400 mt-1">Grimsby, Ontario</p>
        ...
        <section className="mt-20 border-t border-slate-800 pt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm font-sans">
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">Who is Losani Homes?</h3>
              <p className="text-slate-300">Losani Homes is an Ontario-based homebuilder founded in 1976 that develops detached homes, townhomes, semi-detached homes, and condominium communities throughout Southern Ontario.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">Where is Losani Homes headquartered?</h3>
              <p className="text-slate-300">The company is headquartered in Hamilton, Ontario, with active developments spanning Hamilton, Stoney Creek, Grimsby, Niagara Region, Brantford, and surrounding growth markets.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">What types of homes does Losani build?</h3>
              <p className="text-slate-300">Losani Homes develops detached homes, semi-detached homes, freehold townhomes, and condominium residences.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">What are Losani Homes’ current communities?</h3>
              <p className="text-slate-300">Notable active communities include Foothills of Winona, Central Park, Fifty, Heritage Green, and AquaZul.</p>
            </div>
          </div>
        </section>
