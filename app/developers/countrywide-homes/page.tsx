...
export const metadata: Metadata = {
  title: 'CountryWide Homes | Pre-Construction & New Communities in Ontario | Findle',
  description: 'Explore CountryWide Homes\' pre-construction detached, semi-detached, and freehold townhomes across Vaughan, Richmond Hill, Brampton, and the GTA on Findle.',
};

export default async function CountryWideHomesPage() {
  ...
  // 2. Filter properties specifically for CountryWide Homes using clean normalization
          ...
          <div className="grid items-center gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              <div className="mb-3 text-[9px] uppercase tracking-[0.22em] text-indigo-400">
                Verified Developer Profile // Established 2005 in Concord, Ontario
              </div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-300 font-sans">
                CountryWide Homes is an Ontario-based homebuilder and developer recognized for creating low-rise residential communities throughout the Greater Toronto Area and surrounding growth markets. Since its establishment in 2005, the company has delivered more than 28 communities featuring detached, semi-detached, and freehold townhomes designed for modern family living.
              </p>
            </div>
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-xl border border-slate-700 bg-slate-950 flex items-center justify-center p-6">
                ...
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRR7f3eiZgfaAU_bb1I39DVHkXNfOGxN_SVeoHEWjy&s=10"
                  alt="CountryWide Homes logo"
        ...
        <section className="mb-16 grid grid-cols-1 md:grid-cols-2 gap-8 border border-slate-800 bg-slate-900/20 p-6 sm:p-8 rounded-2xl">
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-300 font-sans">
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Developer:</strong> CountryWide Homes</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Founded:</strong> 2005</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Headquarters:</strong> Concord, Ontario</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Primary Markets:</strong> GTA & Surrounding Ontario Markets</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Property Types:</strong> Detached, Semi-Detached, Freehold Townhomes</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-slate-300 font-sans">
              <div>
                <strong className="text-white font-mono text-xs uppercase block text-indigo-400">York Region</strong>
                <p className="text-xs mt-1">Extensive active and upcoming low-rise communities spanning Vaughan (Woodend Place, Sora Vista), Richmond Hill (Jefferson Reserve, Richview Heights), Markham, Aurora, East Gwillimbury (Queensville), and Keswick.</p>
              </div>
              <div>
                <strong className="text-white font-mono text-xs uppercase block text-indigo-400">Peel Region</strong>
                <p className="text-xs mt-1">Dynamic family neighbourhoods including active townhomes in Brampton (Bodhi) and future master-planned releases like Mayfield Village, alongside regional expansion in Caledon.</p>
              </div>
              <div>
                <strong className="text-white font-mono text-xs uppercase block text-indigo-400">Simcoe Region</strong>
                <p className="text-xs mt-1">Growth corridor housing developments including Bond Head in Bradford West Gwillimbury and future community planning in Barrie.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          {developerProperties.length > 0 ? (
            ...
            <div className="grid grid-cols-1 gap-y-12 gap-x-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-white mt-2">Woodend Place</h3>
                <p className="text-xs text-slate-400 mt-1">Vaughan, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Freehold Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Now Selling</span>
                <h3 className="text-lg font-bold text-white mt-2">Bodhi</h3>
                <p className="text-xs text-slate-400 mt-1">Brampton, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Freehold Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Now Selling</span>
                <h3 className="text-lg font-bold text-white mt-2">Bond Head</h3>
                <p className="text-xs text-slate-400 mt-1">Bradford West Gwillimbury, Ontario</p>
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-white mt-2">Sora Vista</h3>
                <p className="text-xs text-slate-400 mt-1">Vaughan, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Under Construction</span>
                <h3 className="text-lg font-bold text-white mt-2">Queensville</h3>
                <p className="text-xs text-slate-400 mt-1">East Gwillimbury, Ontario</p>
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-white mt-2">Jefferson Reserve</h3>
                <p className="text-xs text-slate-400 mt-1">Richmond Hill, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached, Semi-Detached, Townhomes</div>
              </div>
            </div>
          )}
        </section>
        ...
        <section className="mt-20 border-t border-slate-800 pt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm font-sans">
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">Who is CountryWide Homes?</h3>
              <p className="text-slate-300">CountryWide Homes is an Ontario-based homebuilder established in 2005 that develops detached homes, semi-detached homes, and freehold townhome communities throughout the GTA and surrounding regions.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">Where does CountryWide build?</h3>
              <p className="text-slate-300">The company builds in Vaughan, Richmond Hill, Markham, Brampton, Caledon, East Gwillimbury, Barrie, Aurora, Keswick, and other Ontario markets.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">What types of homes does CountryWide build?</h3>
              <p className="text-slate-300">CountryWide Homes develops detached homes, semi-detached homes, and freehold townhomes designed with functional floorplans for modern families.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">What communities are currently active or coming soon?</h3>
              <p className="text-slate-300">Current communities include Woodend Place, Bodhi, Bond Head, Sora Vista, and Queensville, alongside upcoming future releases like Jefferson Reserve and Mayfield Village.</p>
            </div>
          </div>
        </section>
