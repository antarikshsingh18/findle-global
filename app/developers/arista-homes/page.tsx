...
export const metadata: Metadata = {
  title: 'Arista Homes | New & Pre-Construction Communities in Ontario | Findle',
  description: 'Explore Arista Homes communities, detached homes, semi-detached homes, and townhomes across Brampton, Caledon, Vaughan, and the GTA on Findle.',
};

export default async function AristaHomesPage() {
  ...
  // 2. Filter properties specifically for Arista Homes using clean normalization
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
          ...
          <div className="grid items-center gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              <div className="mb-3 text-[9px] uppercase tracking-[0.22em] text-indigo-400">
                Verified Developer Profile // Founded 1994 // Part of Paradise Developments
              </div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-300 font-sans">
                Arista Homes is one of Ontario’s most established homebuilders, recognized for delivering thoughtfully planned residential communities throughout the Greater Toronto Area and surrounding growth markets. Since 1994, the company has built a reputation for quality craftsmanship, innovative design, and customer-focused construction.
              </p>
            </div>
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-xl border border-slate-700 bg-slate-950 flex items-center justify-center p-6">
                ...
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZRwDJ7SyHNkHhnyt27zU9OqXQLIaGEXWRwx5-vVpJNg&s=10"
                  alt="Arista Homes logo"
              ...
              <div className="mt-3 grid grid-cols-2 gap-3">
                <div className="rounded-lg border border-slate-800 bg-slate-950/80 p-3">
                  ...
                  <span className="mt-1 block text-xl font-bold text-emerald-400">{totalProjects > 0 ? totalProjects : 4}</span>
                </div>
                <div className="rounded-lg border border-slate-800 bg-slate-950/80 p-3">
        ...
        <section className="mb-16 grid grid-cols-1 md:grid-cols-2 gap-8 border border-slate-800 bg-slate-900/20 p-6 sm:p-8 rounded-2xl">
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-300 font-sans">
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Developer:</strong> Arista Homes</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Founded:</strong> 1994</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Headquarters:</strong> Vaughan, Ontario</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Parent Group:</strong> Paradise Developments</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Property Types:</strong> Detached, Semi-Detached, Townhomes</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-slate-300 font-sans">
              <div>
                <strong className="text-white font-mono text-xs uppercase block text-indigo-400">GTA Growth Markets</strong>
                <p className="text-xs mt-1">Focused presence across Brampton, Caledon, Vaughan, Oakville, Milton, Richmond Hill, Markham, Ajax, Pickering, and Mississauga.</p>
              </div>
              <div>
                <strong className="text-white font-mono text-xs uppercase block text-indigo-400">Family-Centric Planning</strong>
                <p className="text-xs mt-1">Projects prioritize connectivity, energy efficiency, and proximity to transit, parks, and schools.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="text-xs tracking-[0.2em] text-slate-400 uppercase mb-6 flex items-center justify-between border-b border-slate-800 pb-4">
            <span>ACTIVE & FEATURED DEVELOPMENTS ({totalProjects > 0 ? totalProjects : 4})</span>
          ...
          {developerProperties.length > 0 ? (
            ...
            <div className="grid grid-cols-1 gap-y-12 gap-x-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-white mt-2">High Point</h3>
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Mayfield Collection</h3>
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Riverwalk East</h3>
                <p className="text-xs text-slate-400 mt-1">Ajax, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes & Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Woodland Chase</h3>
        ...
        <section className="mt-20 border-t border-slate-800 pt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm font-sans">
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">Who is Arista Homes?</h3>
              <p className="text-slate-300">Arista Homes is an Ontario homebuilder operating since 1994 as part of Paradise Developments, creating detached, semi-detached, and townhome communities throughout the GTA.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">Where does Arista build?</h3>
              <p className="text-slate-300">The company builds across many Ontario municipalities including Brampton, Caledon, Vaughan, Richmond Hill, Markham, Oakville, Milton, Ajax, Pickering, and Mississauga.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">What home styles are offered?</h3>
              <p className="text-slate-300">Arista Homes specializes in low-rise residential housing, specifically detached homes, semi-detached homes, and townhome communities.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">What are the current communities?</h3>
              <p className="text-slate-300">Key current communities include High Point (Caledon), Mayfield Collection (Brampton), Riverwalk East (Ajax), and Woodland Chase (Oakville).</p>
            </div>
          </div>
        </section>
