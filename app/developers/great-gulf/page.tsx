...
export const metadata: Metadata = {
  title: 'Great Gulf | Pre-Construction & New Communities in Ontario | Findle',
  description: 'Explore Great Gulf communities, detached homes, townhomes, and condominiums across Toronto, Whitby, Milton, Oakville, and Southern Ontario on Findle.',
};

export default async function GreatGulfPage() {
  ...
  // 2. Filter properties specifically for Great Gulf using clean normalization
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
          ...
          <div className="grid items-center gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              <div className="mb-3 text-[9px] uppercase tracking-[0.22em] text-indigo-400">
                Verified Developer Profile // Founded 1975 // 100,000+ Homes Built
              </div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-300 font-sans">
                Great Gulf is one of Canada&apos;s most established and recognized homebuilders, with a history dating back to 1975. Headquartered in Toronto, Ontario, the company develops detached homes, semi-detached homes, townhomes, condominiums, and master-planned communities across Ontario and North America.
              </p>
            </div>
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-xl border border-slate-700 bg-slate-950 flex items-center justify-center p-6">
                ...
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSHI3cGswWgHyA0H3mdH6yUENwDxjN62uUjHi_PHMFbpw&s=10"
                  alt="Great Gulf logo"
              ...
              <div className="mt-3 grid grid-cols-2 gap-3">
                <div className="rounded-lg border border-slate-800 bg-slate-950/80 p-3">
                  ...
                  <span className="mt-1 block text-xl font-bold text-emerald-400">{totalProjects > 0 ? totalProjects : 9}</span>
                </div>
                <div className="rounded-lg border border-slate-800 bg-slate-950/80 p-3">
        ...
        <section className="mb-16 grid grid-cols-1 md:grid-cols-2 gap-8 border border-slate-800 bg-slate-900/20 p-6 sm:p-8 rounded-2xl">
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-300 font-sans">
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Developer:</strong> Great Gulf</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Founded:</strong> 1975</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Headquarters:</strong> Toronto, Ontario</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Primary Markets:</strong> GTA & Southern Ontario</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Property Types:</strong> Detached Homes, Semi-Detached Homes, Townhomes, Condominiums</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-slate-300 font-sans">
              <div>
                <strong className="text-white font-mono text-xs uppercase block text-indigo-400">Toronto & GTA Core</strong>
                <p className="text-xs mt-1">Headquartered in Toronto with landmark high-rise condominium developments and master-planned residential communities across Peel, Halton, and Durham regions.</p>
              </div>
              <div>
                <strong className="text-white font-mono text-xs uppercase block text-indigo-400">Simcoe & Dufferin Counties</strong>
                <p className="text-xs mt-1">Expanding low-rise communities throughout Barrie, Bradford, and Orangeville.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="text-xs tracking-[0.2em] text-slate-400 uppercase mb-6 flex items-center justify-between border-b border-slate-800 pb-4">
            <span>ACTIVE & FEATURED DEVELOPMENTS ({totalProjects > 0 ? totalProjects : 9})</span>
          ...
          {developerProperties.length > 0 ? (
            ...
            <div className="grid grid-cols-1 gap-y-12 gap-x-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-white mt-2">Whitby Meadows</h3>
                <p className="text-xs text-slate-400 mt-1">Whitby, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes & Semi-Detached Homes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Now Selling</span>
                <h3 className="text-lg font-bold text-white mt-2">Milton Village</h3>
                <p className="text-xs text-slate-400 mt-1">Milton, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached, Semi-Detached & Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Now Selling</span>
                <h3 className="text-lg font-bold text-white mt-2">Reva Westfield</h3>
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-white mt-2">Westfield</h3>
                <p className="text-xs text-slate-400 mt-1">Brampton, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Oakpointe</h3>
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Terra</h3>
                <p className="text-xs text-slate-400 mt-1">Barrie, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Five Creeks Estates</h3>
                <p className="text-xs text-slate-400 mt-1">Orangeville, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached, Semi & Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">8 Cumberland</h3>
                <p className="text-xs text-slate-400 mt-1">Toronto, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Condominiums</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">357 King West</h3>
                <p className="text-xs text-slate-400 mt-1">Toronto, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Condominiums</div>
              </div>
            </div>
        ...
        <section className="mt-20 border-t border-slate-800 pt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm font-sans">
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">Who is Great Gulf?</h3>
              <p className="text-slate-300">Great Gulf is a Toronto-based homebuilder founded in 1975 that develops detached homes, semi-detached homes, townhomes, and condominium communities throughout Ontario and North America.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">Where is Great Gulf headquartered?</h3>
              <p className="text-slate-300">The company is headquartered in Toronto, Ontario, with active residential developments spanning Whitby, Brampton, Milton, Oakville, Barrie, Orangeville, East Gwillimbury, and Toronto.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">What types of homes does Great Gulf build?</h3>
              <p className="text-slate-300">Great Gulf builds detached homes, semi-detached homes, freehold/urban townhomes, and landmark high-rise condominiums.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">What are Great Gulf&apos;s current communities?</h3>
              <p className="text-slate-300">Current active communities include Whitby Meadows, Milton Village, Reva Westfield, Westfield, Oakpointe, Terra, Five Creeks Estates, 8 Cumberland, and 357 King West.</p>
            </div>
          </div>
        </section>
