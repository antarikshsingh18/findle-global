...
export const metadata: Metadata = {
  title: 'Fusion Homes | New & Pre-Construction Communities in Ontario | Findle',
  description: 'Explore Fusion Homes communities, detached homes, townhomes, urban towns, and condos across Guelph, Kitchener, Cambridge, and Southwestern Ontario on Findle.',
};

export default async function FusionHomesPage() {
  ...
  // 2. Filter properties specifically for Fusion Homes using clean normalization
          ...
          <div className="grid items-center gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              <div className="mb-3 text-[9px] uppercase tracking-[0.22em] text-indigo-400">
                Verified Developer Profile // Founded 1999 // 6x Tarion Award Winner
              </div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-300 font-sans">
                Fusion Homes is an award-winning Ontario homebuilder headquartered in Guelph, Ontario. Founded in 1999 by Lee Piccoli, the company has built a reputation for delivering high-quality detached homes, townhomes, urban towns, and condominium communities throughout Southwestern Ontario with a strong focus on customer satisfaction.
              </p>
            </div>
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-xl border border-slate-700 bg-slate-950 flex items-center justify-center p-6">
                ...
                <img
                  src="https://fusionhomes.com/app/uploads/2019/08/Fusion_Logo_01@2x-300x102.png"
                  alt="Fusion Homes logo"
        ...
        <section className="mb-16 grid grid-cols-1 md:grid-cols-2 gap-8 border border-slate-800 bg-slate-900/20 p-6 sm:p-8 rounded-2xl">
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-300 font-sans">
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Developer:</strong> Fusion Homes</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Founded:</strong> 1999 (Lee Piccoli)</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Headquarters:</strong> Guelph, Ontario</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Primary Markets:</strong> Guelph, Kitchener, Cambridge, Waterloo Region, Woodstock</li>
              <li><strong className="text-slate-100 font-mono text-xs uppercase">Property Types:</strong> Detached Homes, Townhomes, Urban Towns, Condominiums</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-slate-300 font-sans">
              <div>
                <strong className="text-white font-mono text-xs uppercase block text-indigo-400">Guelph Headquarters & Wellington County</strong>
                <p className="text-xs mt-1">Headquartered in Guelph with prominent developments including Solterra, The Metalworks, and the upcoming Guelph Innovation District.</p>
              </div>
              <div>
                <strong className="text-white font-mono text-xs uppercase block text-indigo-400">Waterloo Region & Oxford County</strong>
                <p className="text-xs mt-1">Active communities spanning Kitchener, Cambridge, Waterloo, and Woodstock.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          {developerProperties.length > 0 ? (
            ...
            <div className="grid grid-cols-1 gap-y-12 gap-x-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-white mt-2">Alister at Solterra</h3>
                <p className="text-xs text-slate-400 mt-1">Guelph, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Anthem at The Metalworks</h3>
                <p className="text-xs text-slate-400 mt-1">Downtown Guelph, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Condominiums</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Sora at The Glade</h3>
                <p className="text-xs text-slate-400 mt-1">Guelph, Ontario</p>
              ...
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-white mt-2">NOMI</h3>
                <p className="text-xs text-slate-400 mt-1">Kitchener, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Urban Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Mari at Williamsburg</h3>
                <p className="text-xs text-slate-400 mt-1">Kitchener, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Trussler West</h3>
                <p className="text-xs text-slate-400 mt-1">Kitchener, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes & Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Wallaceton Urban Towns</h3>
                <p className="text-xs text-slate-400 mt-1">Kitchener, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Urban Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Cadence</h3>
                <p className="text-xs text-slate-400 mt-1">Cambridge, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes & Townhomes</div>
              </div>
              <div className="border border-slate-800 bg-slate-900/40 rounded-xl p-6">
                <span className="text-[9px] text-emerald-400 font-bold uppercase">● Active Community</span>
                <h3 className="text-lg font-bold text-white mt-2">Tidra</h3>
                <p className="text-xs text-slate-400 mt-1">Woodstock, Ontario</p>
                <div className="mt-4 pt-4 border-t border-slate-800 text-xs text-slate-300">Detached Homes & Townhomes</div>
              </div>
            </div>
          )}
        ...
        <section className="mt-20 border-t border-slate-800 pt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm font-sans">
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">Who is Fusion Homes?</h3>
              <p className="text-slate-300">Fusion Homes is a Guelph-based Ontario homebuilder founded in 1999 by Lee Piccoli that develops detached homes, townhomes, urban towns, and condominium communities throughout Southwestern Ontario.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">Where is Fusion Homes headquartered?</h3>
              <p className="text-slate-300">The company is headquartered in Guelph, Ontario, with active developments spanning Guelph, Kitchener, Cambridge, Waterloo Region, and Woodstock.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">What types of homes does Fusion Homes build?</h3>
              <p className="text-slate-300">Fusion Homes develops detached homes, traditional townhomes, urban townhomes, and condominium residences.</p>
            </div>
            <div className="border border-slate-800 bg-slate-900/30 p-6 rounded-xl">
              <h3 className="font-bold text-white font-mono uppercase text-xs mb-2 text-indigo-400">What are Fusion Homes’ current communities?</h3>
              <p className="text-slate-300">Current communities include Alister at Solterra, Anthem at The Metalworks, Sora at The Glade, NOMI, Mari at Williamsburg, Trussler West, Wallaceton Urban Towns, Cadence, and Tidra.</p>
            </div>
          </div>
        </section>
